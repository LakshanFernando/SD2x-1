...
public class MovieRatingsProcessor {
	...
	public static List<String> getAlphabeticalMovies(TreeMap<String, PriorityQueue<Integer>> movieRatings) {
		...
		if (movieRatings == null || movieRatings.isEmpty()) return alphabeticalMovies;
	...
	public static TreeMap<String, Integer> removeAllRatingsBelow(TreeMap<String, PriorityQueue<Integer>> movieRatings, int rating) {
	    ...
	    if (movieRatings == null || movieRatings.isEmpty() || rating < 0) return removedRatings;
	    ...
	    for (Map.Entry<String, PriorityQueue<Integer>> entry : movieRatings.entrySet()) {
	        ...
	        if (ratings.isEmpty()) emptyRatings.add(entry.getKey());
